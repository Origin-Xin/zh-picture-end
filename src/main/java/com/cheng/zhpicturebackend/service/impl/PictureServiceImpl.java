...
import com.cheng.zhpicturebackend.api.aliyunai.model.CreateOutPaintingTaskRequest;
...
import com.cheng.zhpicturebackend.manger.CosManager;
import com.cheng.zhpicturebackend.manger.FileManager;
import com.cheng.zhpicturebackend.manger.upload.FilePictureUpload;
import com.cheng.zhpicturebackend.manger.upload.PictureUploadTemplate;
import com.cheng.zhpicturebackend.manger.upload.UrlPictureUpload;
import com.cheng.zhpicturebackend.model.dto.picture.*;
import com.cheng.zhpicturebackend.model.dto.file.UploadPictureResult;
...
import com.cheng.zhpicturebackend.mapper.PictureMapper;
import com.cheng.zhpicturebackend.service.SpaceService;
import com.cheng.zhpicturebackend.service.UserService;
import com.cheng.zhpicturebackend.utils.ColorSimilarUtils;
import com.cheng.zhpicturebackend.utils.ColorTransformUtils;
...
//        picture.setPicColor(uploadPictureResult.getPicColor());
    ...
    public List<PictureVO> searchPictureByColor(Long SpaceId, String picColor, User loginUser) {
        ...
        // 4. 计算相似度并排序
        List<Picture> sortedPictures  = pictureList.stream().sorted(Comparator.comparingDouble(
                        picture -> {
                            // 提取图片主色调
    ...
    public void editPictureByBatch(PictureEditByBatchRequest pictureEditByBatchRequest, User loginUser) {
        ...
        // 3. 查询指定图片，仅选择需要的字段
        List<Picture> pictureList = this.lambdaQuery()
                .select(Picture::getId, Picture::getPicColor)
                .eq(Picture::getSpaceId, space.getId())
    ...
    public CreateOutPaintingTaskResponse createPictureOutPaintingTask(CreatePictureOutPaintingTaskRequest createPictureOutPaintingTaskRequest, User loginUser) {
        ...
        Picture picture = Optional.ofNullable(this.getById(pictureId)).orElseThrow(() -> new BusinessException(ErrorCode.PARAMS_ERROR));
        // 权限校验
        //改为注解权限校验
